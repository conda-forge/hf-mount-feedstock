About hf-mount-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hf-mount-feedstock/blob/main/LICENSE.txt)

Home: https://github.com/huggingface/hf-mount

Package license: Apache-2.0

Summary: Mount Hugging Face Buckets and repos as local filesystems. No download, no copy, no waiting.

Development: https://github.com/huggingface/hf-mount
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=27940&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hf-mount-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=27940&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hf-mount-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>osx_arm64</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=27940&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hf-mount-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Installing `hf-mount` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
pixi add hf-mount hf-mount-fuse hf-mount-nfs
# for installing globally
pixi global install hf-mount hf-mount-fuse hf-mount-nfs
```
...
It is possible to list all of the versions of `hf-mount` available on your platform:

<details>
<summary>With conda</summary>

```
conda search hf-mount --channel conda-forge
```
...
```
mamba search hf-mount --channel conda-forge
```
...
```
pixi search hf-mount --channel conda-forge
```
...
mamba repoquery search hf-mount --channel conda-forge

# List packages depending on `hf-mount`:
mamba repoquery whoneeds hf-mount --channel conda-forge

# List dependencies of `hf-mount`:
mamba repoquery depends hf-mount --channel conda-forge
```
...
Updating hf-mount-feedstock
===========================

If you would like to improve the hf-mount recipe or build a new
...
Note that all branches in the conda-forge/hf-mount-feedstock are
